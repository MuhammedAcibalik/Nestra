 ...
 */
export function calculate1DStatistics(activeBars: readonly IActiveBar[], totalPiecesPlaced: number): I1DStatistics {
 ...
 */
export function calculate2DStatistics(activeSheets: readonly IActiveSheet[], totalPiecesPlaced: number): I2DStatistics {
 ...
 */
export function calculateSheetWaste(sheet: IActiveSheet): {
    wasteArea: number;
