...
import { IReportRepository, WasteReportData, EfficiencyData, CustomerReportData } from '../report.repository';
import { mock, MockProxy } from 'jest-mock-extended';

describe('ReportService', () => {
    let service: ReportService;
    let repository: MockProxy<IReportRepository>;

    beforeEach(() => {
        repository = mock<IReportRepository>();
