...
export { LocationRepository, ILocationRepository, LocationWithRelations, ILocationFilter, ICreateLocationInput, IUpdateLocationInput } from './location.repository';
