...
import { IOrderDto, IOrderItemDto, ICustomerDto } from '../../core/interfaces';
import { OrderWithRelations, OrderItem } from './order.repository';

/**
 * Maps Order entity to DTO
 */
export function toOrderDto(order: OrderWithRelations): IOrderDto {
 ...
 */
export function toOrderItemDto(item: OrderItem): IOrderItemDto {
    return {
        id: item.id,
