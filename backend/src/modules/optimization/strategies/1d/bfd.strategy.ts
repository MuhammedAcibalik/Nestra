...
export class BFDStrategy implements I1DAlgorithm {
    ...
    private tryPlaceInBestBar(activeBars: ActiveBar[], piece: ExpandedPiece, kerf: number): boolean {
        // Find bar with minimum remaining space that still fits the piece
        let bestBar: ActiveBar | null = null;
    ...
    private tryCreateNewBar(
        ...
        let bestStock: I1DStock | null = null;
