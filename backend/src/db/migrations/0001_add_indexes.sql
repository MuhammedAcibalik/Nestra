...
CREATE INDEX IF NOT EXISTS idx_activities_tenant_actor ON activities(tenant_id, actor_id);
...
CREATE INDEX IF NOT EXISTS idx_document_locks_user ON document_locks(locked_by_id);
