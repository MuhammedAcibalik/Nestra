...
export const machineCompatibilities = pgTable('machine_compatibilities', {
    id: uuid('id').primaryKey().defaultRandom(),
    ...
    unique('machine_compat_unique').on(table.machineId, table.materialTypeId, table.thicknessRangeId)
]);
