...
describe('1D Cutting Algorithm - Mathematical Tests', () => {
    ...
    describe('Algorithmic Properties', () => {
        ...
        it('BFD should produce equal or less waste than FFD for identical input', () => {
            ...
            const ffdResult = (0, cutting1d_1.firstFitDecreasing)(pieces, stock, defaultOptions);
            const bfdResult = (0, cutting1d_1.bestFitDecreasing)(pieces, stock, defaultOptions);
    ...
    describe('Algorithm Selection', () => {
        it('should use FFD when algorithm option is FFD', () => {
            ...
            const result = (0, cutting1d_1.optimize1D)(pieces, stock, options);
            expect(result.success).toBe(true);
        });
...
//# sourceMappingURL=cutting1d.mathematical.spec.js.map