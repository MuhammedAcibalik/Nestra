...
exports.machineCompatibilities = (0, pg_core_1.pgTable)('machine_compatibilities', {
    ...
    machineId: (0, pg_core_1.uuid)('machine_id')
        .notNull()
        .references(() => exports.machines.id, { onDelete: 'cascade' }),
    materialTypeId: (0, pg_core_1.uuid)('material_type_id')
        .notNull()
        .references(() => material_1.materialTypes.id, { onDelete: 'cascade' }),
    ...
    createdAt: (0, pg_core_1.timestamp)('created_at').defaultNow().notNull(),
    updatedAt: (0, pg_core_1.timestamp)('updated_at').defaultNow().notNull()
}, (table) => [(0, pg_core_1.unique)('machine_compat_unique').on(table.machineId, table.materialTypeId, table.thicknessRangeId)]);
