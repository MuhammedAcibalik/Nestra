...
exports.activities = (0, pg_core_1.pgTable)('activities', {
    ...
    actorId: (0, pg_core_1.uuid)('actor_id').notNull().references(() => auth_1.users.id),
...
exports.activityReadStatus = (0, pg_core_1.pgTable)('activity_read_status', {
    activityId: (0, pg_core_1.uuid)('activity_id').notNull().references(() => exports.activities.id, { onDelete: 'cascade' }),
    userId: (0, pg_core_1.uuid)('user_id').notNull().references(() => auth_1.users.id, { onDelete: 'cascade' }),
    readAt: (0, pg_core_1.timestamp)('read_at').defaultNow().notNull(),
}, (table) => [
    (0, pg_core_1.primaryKey)({ columns: [table.activityId, table.userId] })
]);
