...
exports.optimizationScenarios = (0, pg_core_1.pgTable)('optimization_scenarios', {
    ...
    cuttingJobId: (0, pg_core_1.uuid)('cutting_job_id')
        .notNull()
...
exports.cuttingPlans = (0, pg_core_1.pgTable)('cutting_plans', {
    ...
    scenarioId: (0, pg_core_1.uuid)('scenario_id')
        .notNull()
...
exports.cuttingPlanStocks = (0, pg_core_1.pgTable)('cutting_plan_stocks', {
    ...
    cuttingPlanId: (0, pg_core_1.uuid)('cutting_plan_id')
        .notNull()
        .references(() => exports.cuttingPlans.id, { onDelete: 'cascade' }),
    ...
    createdAt: (0, pg_core_1.timestamp)('created_at').defaultNow().notNull(),
    updatedAt: (0, pg_core_1.timestamp)('updated_at').defaultNow().notNull()
}, (table) => [(0, pg_core_1.unique)('cutting_plan_stock_seq').on(table.cuttingPlanId, table.sequence)]);
