...
export declare class OptimizationStrategyRegistry {
    private strategies1D;
    private strategies2D;
...
export { CuttingPiece1D, StockBar1D, Optimization1DResult, Optimization1DOptions, CuttingPiece2D, StockSheet2D, Optimization2DResult, Optimization2DOptions };
